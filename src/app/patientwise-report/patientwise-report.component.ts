...
@Component({
  selector: 'app-patientwise-report',
  templateUrl: './patientwise-report.component.html',
  styleUrls: ['./patientwise-report.component.scss'],
  providers: [DatePipe]
})
export class PatientwiseReportComponent implements OnInit {
  today = new Date();
  reportData: any = [];
  from_date: any;
  to_date: any;
  fileName = 'PatientWise.xlsx';
  constructor(private dp: DatePipe, private patientwiseService: PatientwiseReportService,
  ...
  export2Excel() {
    this.us.export2Excel('excel-table', 'PatientWise.xlsx')
