...
export class InventoryConfigComponent implements OnInit {
  ...
  constructor(
    ...
    private icService: inventoryConfigService,
    private dialog: MatDialog,
    private pos: PoService,
    private spService: suppProdService,
  ...
  fetchBu() {
    this.refService.fetchBuList().subscribe((data) => {
  ...
  edit(element: any) {
    ...
    this.inventoryForm.controls.part_of_inventory.setValue(
      element.part_of_inventory
    );
  }
